...
import com.rahul.aquavision.databinding.FragmentAnalyticsBinding
import java.io.File
...
class AnalyticsFragment : Fragment() {
    ...
    private fun setupSizeDistribution() {
        ...
        fun addRow(label: String, count: Int, color: Int, description: String) {
            ...
            row.background.setTint(Color.parseColor("#1AFFFFFF"))
            ...
            countTv.setTextColor(Color.parseColor("#B0BEC5"))
